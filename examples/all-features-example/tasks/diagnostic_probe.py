...
CG_TASK = {
    ...
    "outputs": [
        "artifacts/diagnostic_probe/interface.json",
        "artifacts/diagnostic_probe/summary.md"
    ],
    "interface_output": "artifacts/diagnostic_probe/interface.json",
    "claim_blocking": False,
    "gates": [
        {"name": "diagnostic_status", "expr": "interface['status'] == 'diagnostic_only'"}
    ]
}
